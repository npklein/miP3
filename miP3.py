...
blast_small_pickle = script_path+'blast_results'+os.sep+fix_file_names(organism_name+'_blast_small_'+str(args['eval_small'])+'.p')
if developing:
...
reblast_pickle = script_path+'blast_results'+os.sep+fix_file_names(organism_name+'reblast'+str(args['eval_all'])+'.p')
if developing:
